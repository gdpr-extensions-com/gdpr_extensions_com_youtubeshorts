...
{
    /**
     * @var \GdprExtensionsCom\GdprExtensionsComYoutubeShorts\Domain\Model\GdprManager|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \GdprExtensionsCom\GdprExtensionsComYoutubeShorts\Domain\Model\GdprManager::class,
            ['dummy']
        );
    }
